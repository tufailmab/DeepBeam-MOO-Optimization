<h1>Deep Beam Performance Optimizer</h1>
...
<h2>Contents</h2>
<ul>
  <li>Experimental dataset and analysis</li>
  <li>Implementation of four parametric performance indicators</li>
  <li>Multi-objective optimization framework using Octopus MOO</li>
